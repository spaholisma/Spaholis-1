...
export const content = {
  ...
  // ── Custom Retreat Page (multi-step inquiry form) ──
  ...
  customRetreat: {
    ...
    subtitle: "Tell us what you envision — we'll craft a bespoke wellness journey just for you.",
    stepNames: ["About You", "Your Vision", "Dates & Duration", "Personalize"],
    backLabel: "Back",
    ...
    step1: {
      title: "Your Retreat Vision",
      subtitle: "What are you looking for? Select all that resonate.",
      activitiesLabel: "Preferred Activities",
      whoLabel: "Who's Joining?",
    },
    step2: {
      title: "Dates & Duration",
      subtitle: "Don't worry if you're not sure yet — we'll work it out together.",
      datesLabel: "Preferred Dates",
      datesPlaceholder: "e.g., March 2025, or specific dates",
      flexibleLabel: "My dates are flexible",
      lengthLabel: "Length of Stay",
      lengthPlaceholder: "e.g., 3 days, 1 week, flexible",
    },
    step3: {
      title: "Final Touches",
      subtitle: "Anything else that would help us design your perfect experience.",
      budgetLabel: "Budget Range (optional)",
      requestsLabel: "Special Requests or Notes",
    ...
    visionOptions: [
      ...
      { value: "Couples Wellness", label: "Couples Wellness" },
    ...
    activityOptions: [
      ...
      { value: "Waterfall Tours", label: "Waterfall Tours" },
      { value: "Organic Facials", label: "Organic Facials" },
      { value: "Breathwork", label: "Breathwork" },
      { value: "Sound Healing", label: "Sound Healing" },
      { value: "Jungle Hikes", label: "Jungle Hikes" },
      { value: "Thai Bodywork", label: "Thai Bodywork" },
      { value: "Body Wraps", label: "Body Wraps" },
