            ...
            >
              <div className="grid md:grid-cols-[1fr_auto] items-center gap-6 p-6 sm:p-8 md:p-10 text-spa-cream">
                ...
                <div className="shrink-0 w-full md:w-auto">
                  <Button asChild variant="ghost" size="xl" className="w-full md:w-auto whitespace-normal text-center h-auto min-h-12 py-3 leading-tight rounded-full border border-spa-cream/40 text-spa-cream hover:text-spa-cream hover:bg-spa-cream/10">
      ...
      <section className="bg-spa-charcoal">
        <div className="spa-section text-center">
          <motion.div {...fadeIn}>
            ...
            <p className="font-body text-xs text-spa-cream/50 mt-4 tracking-wide"><RichText value={cta.note} path="cta.note" /></p>
          </motion.div>
        </div>
      </section>
